...
class PetFriends:
    ...
    def get_api_key(self, email: str, passwd: str) -> json:
        ...
        JSON с уникальным ключем пользователя, найденного по указанным e-mail и паролю"""
...
### -------------------------------------------------------------------------------------------------------
### Задание 19.7.2 часть 1 -- методы, которые ещё не были реализованы в библиотеке:


    def create_pet_simple (self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """Метод создаёт карточку с данными питомца БЕЗ ФОТО и возвращает
    ...
    def set_photo (self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фотографию в карточку питомца по его ID и возвращает
        статус запроса на сервер и результат в формате JSON с данными о добавленном фото"""
